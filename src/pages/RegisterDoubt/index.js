        ...
        <Box marginTop="3" height="full" padding="7" width="full" justifyContent="space-between">
            <View>
                ...
                <View style={{width:'100%'}}>
                    <Input size="md" borderColor="#52D6FB" borderRadius={20} marginTop={2} width="90%" color="#52D6FB" marginLeft={5}  placeholderTextColor="#52D6FB" placeholder="Insira um titulo"></Input>
