...
export default function Notification({notification, lastWeek}){
    ...
    return(
        <View>
            <View style={{flexDirection:'row', borderColor:'#52D6FB', borderWidth:1.5, marginTop: 10, borderRadius:10, alignItems:"center", padding:'1%', height: 100}}>
                <Avatar 
                    bg='tertiaryBlue' 
                    size='lg'
                    source={{
                ...
                <View style={{margin: 5}} width='4/5'>
                    ...
                    <Text numberOfLines={1} style={{fontSize:14}}>{notification.mensagem}</Text>
