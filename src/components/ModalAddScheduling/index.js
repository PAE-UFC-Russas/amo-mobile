...
export default function ModalAddScheduling({
   ...
   //              showToast(
   //                 "Atenção",
   //                 "Ja existe um agendamento para esse hórario!",
   //                 "warning"
   //              );
   //              setLoading(false);
   //           } else {
   //              showToast(
   //                 "Erro",
   //                 "Não foi possivel realizar o agendamento, tente novamente mais tarde!",
   //                 "error"
   //              );
   //              setLoading(false);
   //           }
   ...
   //        showToast(
   //           "Erro",
   //           "Assunto e descrição deve ter mais de 3 caractere",
   //           "error"
   //        );
   //        setLoading(false);
   //     }
   ...
   const HandlePostNewSchedule = async () => {
      ...
      if (
         newSchedule.assunto.length <= 3 ||
         newSchedule.descricao.length <= 3
      ) {
         showToast(
            "Erro",
                  ...
                  >
                     <VStack width="45%">
                        ...
                        <Button
                           ...
                           onPress={() =>
                              setShowDate({ type: "date", active: true })
                           }
                        >
                     ...
                     <VStack width="45%">
                        ...
                        <Button
                           ...
                           onPress={() =>
                              setShowDate({ type: "time", active: true })
                           }
                        >
