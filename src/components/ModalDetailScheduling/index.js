    ...
    <Modal isOpen={openModal} onClose={HandleOnClose}>
      ...
      >
        <View
          ...
          justifyContent={"space-between"}
        >
          <Text marginLeft={10} fontSize={16} fontWeight="bold" color="#024284">
        ...
        <View marginTop={2} width="100%" padding="3%" borderRadius={4}>
          ...
          {!details.tipo.startsWith("presencial") &&
            details.status !== "cancelado" && (
              <View marginBottom="2%">
                ...
                >
                  <Text fontSize={16}>{filterDesc(details.link_zoom)}</Text>
                </Button>
              </View>
            )}
          <View alignItems={"center"} flexDirection={"row"}>
            ...
            >
              ...
              <Text fontSize={16}>{DateISOToFormated(details.data)}</Text>
            </View>
            <View
              alignItems={"center"}
              justifyContent={"center"}
